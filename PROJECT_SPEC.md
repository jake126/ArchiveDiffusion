...
- Discuss hallucination risk in restoration.
- Discuss authenticity versus enhancement.
- Include nearest-neighbour analysis to check whether outputs resemble training images too closely.
- Make clear that outputs are plausible restorations, not ground-truth historical reconstructions.

## Success criteria for v0.1

- Reproducible dataset preparation on a small public-domain sample.
- Working degradation pipeline.
- Working unconditional DDPM baseline at 64x64.
- Generated sample grid.
- Initial restoration experiment on at least one degradation type.
- Basic PSNR/SSIM evaluation.
- Short technical write-up with limitations and next steps.

## Success criteria for application-ready v1.0

- Polished GitHub README.
- Clear technical report.
- Multiple before/after visual examples.
- At least two degradation types evaluated.
- Sampling speed-quality comparison.
- Honest limitations section.
- CV-ready summary bullet.

## Risks and mitigations

| Risk | Mitigation |
|---|---|
| Model outputs are low quality | Start at 64x64, validate on simple data, then scale gradually |
| Restoration over-smooths archival texture | Include authenticity-preservation analysis and texture metrics |
| Dataset licensing is unclear | Use only explicitly public-domain or permissively licensed material |
| Training is too slow locally | Use compact U-Net, small crops, mixed precision if available, and reduced dataset sizes |
| Project looks like generic image enhancement | Emphasise diffusion fundamentals, archival domain constraints, and evaluation |
| Outputs hallucinate details | Frame as plausible restoration and include failure cases |
