...
class SyntheticRestorationDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # Images are in [-1, 1].
        # Residual is in approximately [-2, 2], so scale to [-1, 1]-ish.
        residual = (target - condition) / 2.0
...
def main(
    ...
    if use_mlflow:
        ...
        mlflow.log_params({
            ...
            "seed": seed,
            "device": str(device),
            "model_type": "residual_conditional_ddpm_unet2d",
            "conditioning": "channel_concat_noisy_residual_plus_degraded_input",
            "target": "scaled_residual_target_minus_condition_div_2",
    ...
    for epoch in range(1, epochs + 1):
        ...
        for batch in progress:
            ...
            # Conditioning: noisy residual + degraded input.
            model_input = torch.cat([noisy_residual, condition], dim=1)
